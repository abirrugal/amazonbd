...
<div class="col-8 col-sm-6 d-flex align-items-start d-lg-none " id="menu_sm">
...
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="30" fill="currentColor" class="bi bi-list" viewBox="3 0 16 16">
  ...
  <div class="d-lg-none">
  <a href="{{route('frontend.product.index')}}" class=" text-white text-decoration-none  logo-text ">
    Dream Ultra      
  </a>
  </div>
...
@auth
<a href="{{route('frontend.user.profile',auth()->user()->name)}}"><button type="button" class="btn btn-outline-light me-3 hidden">Profile</button></a>
...
<div class="d-flex justify-content-center flex-column">
 ...
 <a href="{{route('cart.index')}}" class="text-white" style="text-decoration: none;">
  <button type="button" class="btn text-white mb-0 pb-0 "> <span class="total_cart_items">{{$totalProducts}}</span>
 </button>
</a>
 </span>
 <span>
...
<a href="{{route('frontend.product.index')}}" class=" text-white text-decoration-none  logo-text h5">
  Dream Ultra      
</a>
</div>
...
@endguest
      @auth
      <div class="text-end d-none d-lg-flex">
        <a href="{{route('frontend.user.profile',auth()->user()->name)}}"><button type="button" class="btn btn-outline-light me-3">Profile</button></a>
     ...
     $data=[];
        ...
        <button type="button" class="btn text-white mb-0 pb-0 "> 
         ...
         <span class="total_cart_items">{{$totalProducts}}</span>
        </a>
       </button> 
       <a href="{{route('cart.index')}}" class="text-white m-0 p-0" style="text-decoration: none;"> 
      <svg xmlns="http://www.w3.org/2000/svg" width="39" height="26" fill="currentColor" class="bi bi-cart mt-0 pt-0 mb-4" viewBox="1 1 16 16">
