	...
	<div class="row">
		<div class="col-md-12">
			{{-- <h2>Features <b>Products</b></h2> --}}
				<div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel" data-bs-interval="0">
		...
		{{-- Products images  --}}
			...
			<div class="img-box">
				<div class="d-flex justify-content-center">
					...
					<a href="{{route('frontend.product.show',$top_product['slug'])}}"> <img class=" img-fluid rounded product_img" src=" {{$top_product['image']}}" alt="{{$top_product['slug']}}"> </a>
...
{{-- Title  --}}
<p class="card-text text-start product-title "> <a class=" text-decoration-none" href="{{route('frontend.product.show',$top_product['slug'])}}">{{ Illuminate\Support\Str::limit($top_product['title'], 40)}}  </a> </p>
...
{{-- Add to cart and buy now  --}}
	     ...
	     <!-- Carousel controls -->
		 <a class="carousel-control-prev text-dark text-decoration-none z-index-1000" data-bs-target="#carouselExampleIndicators2" data-bs-slide="prev">
            <i class="fas fa-chevron-left h2"></i>
        </a>

        <a class="carousel-control-next text-dark text-decoration-none z-index-1000" data-bs-target="#carouselExampleIndicators2" data-bs-slide="next">
